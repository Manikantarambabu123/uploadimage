...
const Sidebar = ({ onLogout, activeTab, setActiveTab }) => {
    const menuItems = [
        { id: 'dashboard', label: 'Dashboard', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="6" height="11" rx="1"></rect><rect x="12" y="3" width="9" height="6" rx="1"></rect><rect x="3" y="16" width="9" height="5" rx="1"></rect><rect x="15" y="12" width="6" height="9" rx="1"></rect></svg> },
        ...
        { id: 'assessments', label: 'Assessments', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg> },
